...
const Footer = () => {
  return (
    <footer className="bg-dark pt-24 pb-24 md:pb-12">
      <div className="container">
        <div className="flex flex-wrap">
          ...
          <div className="mb-12 w-full px-4 md:w-1/3">
            <h3 className="mb-2 text-xl font-bold text-white">Hubungi Saya</h3>
        ...
        <div className="w-full border-t border-slate-800 pt-10">
          ...
          <p className="mb-2 pt-4 text-center text-sm font-medium text-slate-100">
            &copy; 2023 Portfolio Bima Hayu Nugraha. All rights reserved.
          </p>
